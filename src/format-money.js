...
const format = function(value, locale, currencyCode, { subunitsValue, subunitsToUnit, hideSubunits, supplementalPrecision }) {
  let ret = 0;
  if (Number.isFinite(value)) {
    try {
      ...
      if (hideSubunits == true) {
        ...
        numFormat = new Intl.NumberFormat(locale, { style: 'currency', currency: currencyCode, minimumFractionDigits: options.minimumFractionDigits + supplementalPrecision , maximumFractionDigits: options.maximumFractionDigits + supplementalPrecision });
      }
